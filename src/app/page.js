    ...
    <SiteFrame>
        ...
        <PageIntro
          ...
          actions={
            <>
              ...
              <SecondaryButton href="/contact">Entrer en contact</SecondaryButton>
            </>
          }
        />
      </SectionContainer>
      ...
      <SectionContainer id="prochainement" className="pt-0">
        <aside className="surface-card px-6 py-5 text-sm leading-7 text-muted sm:px-8">
          Le contenu détaillé arrive bientôt. TODO - Pages éditoriales, agenda,
          ressources et prises de parole seront ajoutés dans les prochaines
          étapes.
        </aside>
      </SectionContainer>
    </SiteFrame>
